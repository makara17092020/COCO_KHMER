...
export default function Navbar() {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 backdrop-blur-lg bg-white/80 shadow-md">
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            {/* Sliding Drawer - Slide from Top */}
            <motion.div
              className="fixed top-0 right-0 w-[70%] h-full bg-[#0C5C4C]/50 z-50 shadow-lg px-6 py-10 backdrop-blur-sm"
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
              exit={{ x: '100%' }}
